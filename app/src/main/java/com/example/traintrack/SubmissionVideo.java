...
public class SubmissionVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submission_video);

        member = new Member();

        storageReference = FirebaseStorage.getInstance().getReference("VideoSubmission");         //This will create a folder name "Video" in firebase storage, where the videos will be saved!
        databaseReference = FirebaseDatabase.getInstance().getReference("videosubmission");          //This will create a folder named "video" in our realtime database, where videos will be saved!

        videoView = findViewById(R.id.videoview_main_s);
        button = findViewById(R.id.button_upload_main_s);
        progressBar = findViewById(R.id.progressBar_main_s);
        editText = findViewById(R.id.et_video_name_s);
    ...
    public void ShowVideo(View view) {
        ...
        Intent intent = new Intent(SubmissionVideo.this, ShowVideoSubmission.class);
            ...
            Task<Uri> urltask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(SubmissionVideo.this, "Data saved", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(SubmissionVideo.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }else {
