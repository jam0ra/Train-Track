...
public class SubmissionViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setExoplayer(Application application, String name, String Videourl) {
        ...
        textView.setText(name);     //this is to set name of of video, same as our realtime database!
        ...
        try {
            ...
            DefaultHttpDataSourceFactory dataSourceFactory = new DefaultHttpDataSourceFactory("videosubmission");
            ExtractorsFactory extractorsFactory = new DefaultExtractorsFactory();
            MediaSource mediaSource = new ExtractorMediaSource(video, dataSourceFactory, extractorsFactory, null, null);
            playerView.setPlayer(exoPlayer);
            exoPlayer.prepare(mediaSource);
            exoPlayer.setPlayWhenReady(false);          //All videos will not play simultaneously!
